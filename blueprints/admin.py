# 博客后台
from flask import Blueprint, flash, request, render_template, redirect, current_app, url_for
from flask_login import login_required, current_user
from commons.utils import redirect_back
from commons.models import Comment, Category, Post
from commons.forms import CategoryForm, PostForm, SettingForm
...
def manage_post():
    ...
    pagination = Post.query.order_by(Post.timestamp.desc()).paginate(
        page=page, per_page=current_app.config['BLOG_MANAGE_POST_PER_PAGE'])
...
@admin.route('/post/<int:post_id>/set-comment', methods=['POST'])
@login_required
